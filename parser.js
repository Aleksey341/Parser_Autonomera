...
class AutonomeraParser {
    constructor(options = {}) {
        ...
        this.concurrentRequests = options.concurrentRequests || 100; // Параллельные запросы (100 по умолчанию)
    ...
    async parseMainPageWithLoadMore(page, onBatchComplete = null) {
        ...
        const itemsPerBatch = 5000; // Останавливаемся после 5,000 объявлений за батч
