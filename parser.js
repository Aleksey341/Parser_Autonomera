...
class AutonomeraParser {
    constructor(options = {}) {
        ...
        this.concurrentRequests = options.concurrentRequests || 500; // Параллельные запросы (500 по умолчанию)
    ...
    async parseMainPageWithLoadMore(page, onBatchComplete = null) {
        ...
        const itemsPerBatch = 3000; // Останавливаемся после 3,000 объявлений за батч
